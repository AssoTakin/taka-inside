...
| 2026-08-15 | **CTA "En savoir plus" lisible** : le lien de la section À propos était rendu en blanc sur fond clair par le composant `CtaButton`. Il est maintenant affiché en texte noir avec une flèche, conforme au design original et piloté par le champ `cta` du composant Strapi `homepage.about-section`. |
