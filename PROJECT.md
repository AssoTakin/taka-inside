...
| 2026-08-15 | **Restauration du style original de la homepage** : retour à la mise en page d'origine (deux cartes côte à côte pour Don + Bénévole, style original de la section À propos, section Radio inchangée). Le bouton WhatsApp flottant était déjà présent dans le code ; il est visible sur la production actuelle. |
