...
| 2026-08-15 | **Restauration du design original de la section À propos** : les statistiques (10+, 5+, 3, 50+) sont désormais intégrées en grille 2x2 directement dans la section À propos, sous le texte et avant le CTA "En savoir plus", comme sur le design original. |
