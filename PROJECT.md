...
| 2026-08-15 | **Boutons Don/Bénévole uniformisés** : les deux boutons de la section Don + Bénévole ont la même largeur, hauteur et alignement (poussés en bas des cartes via `mt-auto`). La carte Bénévole est entièrement pilotée par le composant Strapi `homepage.cta-benevole-section` (titre, description, bouton) au lieu d'être codée en dur. |
