...
function CtaButton({ cta, baseClass }: { cta?: Record<string, unknown> | null; baseClass?: string }) {
  ...
  const className = `${baseClass || ''} ${styleClass} px-6 py-3 rounded-xl font-semibold transition-all inline-flex items-center justify-center gap-2 w-full min-w-0 sm:w-auto sm:min-w-[200px] text-center whitespace-nowrap`;
