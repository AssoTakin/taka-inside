...
export async function fetchLabelMusicalPage(): Promise<Record<string, unknown> | null> {
  return fetchStrapiSingle(
    'label-musical-page?populate[hero][populate][primaryCta]=*&populate[hero][populate][secondaryCta]=*&populate[stats][populate]=*&populate[artistsSectionCta][populate]=*&populate[callout][populate][primaryCta]=*&populate[callout][populate][secondaryCta]=*&populate[actualites][populate][image][populate]=*&populate[seo][populate][ogImage][populate]=*'
  );
}
